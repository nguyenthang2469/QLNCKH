...
import { faBook, faChevronDown, faHouse } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <aside className={cx('wrapper')}>
            <div className={cx('inner', 'pt-10 px-5 font-normal text-3xl')}>
                ...
                <div onClick={handleShow} className="parent flex items-center py-6 cursor-pointer hover:bg-gray-200 rounded-xl px-6">
                    <span>
                        <FontAwesomeIcon className="w-12 mr-6 inline-flex justify-center" icon={faCalendar} />
                    </span>
                ...
                <ul className="hidden">
                    <li><Link className="block rounded-xl pl-[80px] py-4 hover:bg-gray-200 cursor-pointer" to="/teacher/ketquadetai">Đề tài hướng dẫn</Link></li>
                    <li className="mb-6"><Link className="block rounded-xl pl-[80px] py-4 hover:bg-gray-200 cursor-pointer" to="/teacher/ketquacham">Đề tài đã chấm</Link></li>
                </ul>
            </div>
        </aside>
    );
