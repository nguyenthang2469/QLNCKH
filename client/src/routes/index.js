...
import PhancongGVDT from '~/pages/Admin/PhanCongGVDT';
...
const privateRoutes = [
    ...
    { title: 'Kết quả đề tài', path: '/teacher/ketquadetai', component: TeacherKetQuaDeTai, layout: TeacherLayout },
    ...
    { title: 'Kết quả đề tài', path: '/admin/ketquadetai', component: KetQuaDeTai, layout: AdminLayout },
    { title: 'Phân công giáo viên chấm đề tài', path: '/admin/gvdetai', component: PhancongGVDT, layout: AdminLayout },
